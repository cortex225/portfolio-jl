                    ...
                    <div className={"flex-1"}>
                        <Tabs defaultValue={"personal"}>
                            <TabsList
                                ...
                                <TabsTrigger className={"w-[162px] xl:w-auto"} value={"personal"}>Personal
                                    Info</TabsTrigger>
                                <TabsTrigger className={"w-[162px] xl:w-auto"}
                                             value={"qualifications"}>Qualifications</TabsTrigger>
                                ...
                                <TabsContent value={"personal"}>
                                    <div className={"text-center xl:text-left"}>
                                        ...
                                        <p className={"subtitle max-w-xl mx-auto xl:mx-0"}>
                                            I am a full-stack web developer with 2 years of experience. I specialize in
                                            building
                                            responsive and interactive websites and web applications. I am passionate
                                            about
                                            learning new technologies and always look for opportunities to improve my
                                            skills.
                                        </p>
                                        {/*  icons  */}
                                                        ...
                                                        return (
                                                            <div className={" flex gap-x-8 group "}
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div
                                                                        className={" text-lg leading-none text-muted-foreground mb-4"}>{role}</div>
                                                                    <div
                                                                        className={" text-base font-medium"}>{years}</div>
                                                                </div>
                                            ...
                                            <div className={"flex flex-col gap-y-6"}>
                                                ...
                                                <div className={"flex flex-col gap-y-8"}>
                                                    {getData(qualificationsData, "education").data.map((item, index) => {
                                                        ...
                                                        return (
                                                            <div className={" flex gap-x-8 group mt-1"}
                                                                 key={index}>
                                                                <div
                                                                    className={"h-[84px w-[1px] bg-border relative ml-2.5"}>
                                                                    <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div
                                                                        className={" text-lg leading-none text-muted-foreground mb-4"}>{qualification}</div>
                                                                    <div
                                                                        className={" text-base font-medium"}>{years}</div>
                                                                </div>
