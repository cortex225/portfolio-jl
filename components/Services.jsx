...
const servicesData=[
    {
        ...
        description: "I build websites and web applications using modern technologies like React, NextJS, and TailwindCSS.",
...
const Services = () => {
    return (
        ...
        <div className={"container mx-auto"}>
            <h2 className={"section-title mb-12 xl:mb24 text-center mx-auto"}>My Services</h2>
        {/*  grid items  */}
