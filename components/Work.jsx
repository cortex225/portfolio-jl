    ...
    return (
        <section className={"relative mb-12 xl:mb-48"}>
            <div className={"container mx-auto"}>
                {/*  text  */}
                <div
                    className={"max-w-[400px] mx-auto xl:mx-0 text-center xk:text-left mb-12 xl:h-[400px] flex flex-col justify-center items-center xl:items-start"}>
                    <h2 className={"section-title mb-4"}> Lastest Projects</h2>
                    <p className={"subtitle mb-8"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam,
                        consequatur.</p>
                    <Link href={"/work"}>
